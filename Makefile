...
Player_public_test.exe: Card.cpp Player.cpp SimplePlayer.cpp HumanPlayer.cpp Player_public_test.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

Player_tests.exe: Card.cpp Player.cpp Player_tests.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

euchre.exe: Card.cpp Pack.cpp Player.cpp SimplePlayer.cpp HumanPlayer.cpp euchre.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@
